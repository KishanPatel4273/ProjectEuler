...
$p^2 < p \cdot p_{next}$. For our N we get $\prescript{12}{}{P^*} = 70,710,707$.
\begin{equation}
\begin{aligned}
        \sum_{p = \prescript{12}{}{P^*}}^{\pi(N)} G(p) &= \pi(N) - \pi(\prescript{12}{}{P^*}) + 1 \\
        &\approx \frac{N}{\log N} - \frac{\prescript{12}{}{P^*}}{\log \prescript{12}{}{P^*}} + 1 \\
        &\approx 138,319,418,975,671 - 3,912,265 + 1 \\
        &\approx 138,319,415,063,407
\end{aligned}    
\end{equation}
Since $\pi(\prescript{12}{}{P^*}) \approx 3,912,265$, the remaining groups contain
all the numbers that are only composed of the first $3,912,265$ prime numbers.
